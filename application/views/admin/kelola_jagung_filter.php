...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="<?php echo site_url('Admin/tambah_jagung/'.$thn) ?>" class="btn btn-success"> <i class="fa fa-plus"></i> Tambah Data </a>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <?php echo form_open('Admin/filter_jagung',array('class' =>
        'form-horizontal')); ?>
        <div class="row">
	            ...
	            <tbody>
					...
					<?php foreach ($jagung as $key) { ?>
                        ...
                        <div class="btn-group" role="group">
                            <a href="<?php echo site_url('Admin/edit_jagung/'.$key->id_tanaman) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo site_url('Admin/delete_jagung/'.$key->id_tanaman) ?>" onclick="return confirm ('Apakah anda yakin untuk meghapus data ini')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                        </div>
                    </td>
							<?php $no++ ?>
						</tr>
